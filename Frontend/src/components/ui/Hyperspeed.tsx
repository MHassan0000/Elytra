...
const carLightsFragment = `
  #define USE_FOG;
  ${(THREE.ShaderChunk as any)['fog_pars_fragment']}
  varying vec3 vColor;
  varying vec2 vUv; 
  uniform vec2 uFade;
  void main() {
    ...
    ${(THREE.ShaderChunk as any)['fog_fragment']}
  }
`;

const carLightsVertex = `
  #define USE_FOG;
  ${(THREE.ShaderChunk as any)['fog_pars_vertex']}
  ...
  void main() {
    ...
    vUv = uv;
    vColor = aColor;
    ${(THREE.ShaderChunk as any)['fog_vertex']}
  }
`;
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
    const effectOptionsStr = JSON.stringify(effectOptions);
